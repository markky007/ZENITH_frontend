  ...
  template: `
    <div class="min-h-screen bg-luxury-white pt-24 pb-20">
      ...
      <div class="text-center max-w-3xl mx-auto px-6 mb-16 animate-fade-in-up">
        <h1
          class="text-4xl md:text-5xl font-serif text-luxury-black mb-4 tracking-wider uppercase"
        >
          The Collection
        </h1>
        <p class="font-sans text-gray-500 tracking-wide">
          Discover our latest masterpieces, crafted for eternity.
        </p>

        <!-- Filters -->
        <div
          class="flex flex-wrap justify-center gap-6 mt-10 font-sans text-sm tracking-widest uppercase"
        >
          <button
            class="text-luxury-black font-semibold border-b border-luxury-black pb-1"
          >
            All
          </button>
          <button
            class="text-gray-400 hover:text-luxury-black transition-colors pb-1"
          >
            Watches
          </button>
          <button
